# Arduino Core for Afantor Bluefruit52 nRF52 Boards

This repository contains the Arduino BSP for Adafruit nRF52 series:

- [Bluefruit52 nRF52832](https://www.afantor.cc)
...
### Optional (Core Development): Afantor nRF52 BSP via git
...
```
$ nrfjprog -e -f nrf52
$ nrfjprog --program nrf52832_bootloader.hex -f nrf52
...
## Thanks
 ...
 This project forked from adafruit/Adafruit_nRF52_Arduino. All the codes come from there.The right to interpret is owned by Adafruit.
